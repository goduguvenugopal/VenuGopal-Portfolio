      ...
      <div className={`sticky left-0 top-0 w-full bcgc transition-transform duration-300 ${navVisible ? "translate-y-0" : "-translate-y-full"}`}>
        <div className={` lg:shadow-lg p-2 select-none relative ${menu ? "shadow-none" : "shadow-lg"}`}>
          ...
          <div className='flex lg:justify-around lg:items-center'>
            <img src="/logo.jpeg" alt="logo.jpeg" className='ml-1   rounded-full  w-[3.6rem] h-[3.6rem]' />
            <div className=' gap-3 hidden lg:block'>
              <div className='flex gap-[3rem]'>
                <a href='#about' className='text-[1.2rem] text-white font-semibold'>About</a>
                <a href='#skills' className='text-[1.2rem] text-white font-semibold'>Skills</a>
                <a href='#projects' className='text-[1.2rem] text-white font-semibold'>Projects</a>
                <a href='#education' className='text-[1.2rem] text-white font-semibold'>Education</a>
                <a href='#contact' className='text-[1.2rem] text-white font-semibold'>Contact</a>
              </div>
            </div>
            <div>
          ...
          <div
            ref={menuRef}
            className={`absolute  bcgc top-[3.8rem] shadow-lg left-[0.6rem] w-full flex mt-3 lg:hidden flex-col gap-4 px-2  transition-all duration-500 ease-in-out transform origin-top 
    ${menu ? "scale-y-100 opacity-100 pb-2" : "scale-y-0 opacity-0 h-0 overflow-hidden"}`}>
            <a href='#about' className='text-[1.2rem] text-white font-semibold'>About</a>
            <a href='#skills' className='text-[1.2rem] text-white font-semibold'>Skills</a>
            <a href='#projects' className='text-[1.2rem] text-white font-semibold'>Projects</a>
            <a href='#education' className='text-[1.2rem] text-white font-semibold'>Education</a>
