...
const Navbar = () => {
  ...
  return (
    <>
      <main
        className={`sticky left-0 top-0 w-full bcgc z-10 transition-transform duration-300 select-none `}
      >
        <div
          className={` lg:shadow-lg p-2 select-none relative ${
            menu ? "shadow-none" : "shadow-lg"
          }`}
        >
          ...
          <section className="flex lg:justify-around lg:items-center">
            <img
              src="/logo.jpeg"
              alt="logo.jpeg"
              className="ml-1 border-[0.1rem] border-purple-600 rounded-full  w-[3.6rem] h-[3.6rem]"
            />
            <div className=" gap-3 hidden lg:block">
              <div className="flex gap-[3rem]">
                <a
                  href="#about"
                  className="text-[1.2rem] text-white font-semibold hover:text-blue-500"
                >
                  About
                </a>
                <a
            ...
            <div>
              <button className="hidden lg:block cursor-pointer  animate-pulse hover:bg-purple-700 bg-purple-600 text-white font-medium rounded-[3rem] px-4 py-2">
                <a href={bioData.github} target="_self">
                  GitHub Profile
                </a>
              </button>
            </div>
          ...
          <section className="lg:hidden ">
            {menu ? (
              <span
                ...
                className="text-white absolute top-[1.6rem] right-[0.8rem] cursor-pointer"
              >
                <MdClose size={25} />
              </span>
            ) : (
