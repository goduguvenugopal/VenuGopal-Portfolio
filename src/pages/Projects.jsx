      ...
      <main className="p-3 mt-20 border-t-1 pt-18 text-center">
        ...
        <div className="flex justify-center w-full">
          <p className="text-[#9ea2a3] text-[1.1rem] text-center lg:w-[60%]">
            ...
            backend development. From interactive web applications to full-stack
            solutions, here are some of my projects.
          </p>
        </div>
            ...
            .map((project) => (
              ...
              >
                <img
                  src={project.image}
                  alt={project.title}
                  className="w-full rounded-[0.6rem] border  border-gray-500 p-1 outline-red-400"
                />
                ...
                <div className="flex mt-4  items-center gap-2 flex-wrap">
                  {project.techstack.map((tool, index1) => (
                    <div
                      ...
                      key={index1}
                    >
                      <h5 className="text-[#9ea2a3] capitalize font-medium text-[0.8rem]">
                        {tool}
                      </h5>
                    </div>
                  ))}
                ...
                <div className="mt-3 flex justify-between items-center">
                  <h5 className="text-gray-200 text-start capitalize  font-medium text-[1.2rem]">
                    {project.title}
                  </h5>
                  <div className="flex text-white gap-4 items-center">
                    <a
                      ...
                      target="_blank"
                      title="Live Link"
                      className="border border-[#151b23] hover:border-gray-300 p-1 rounded-full"
                    >
                      <TbExternalLink size={19} />
                    </a>
                    <a
                      href={project.github}
                      title="GitHub"
                ...
                <h6 className="text-gray-400  mt-1 text-md text-start">
                  {project.description}
                </h6>
              </section>
            ))
